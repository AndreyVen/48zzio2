...
ACLOCAL = ${SHELL} /usr/local/src/ven/7wuU0x/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /usr/local/src/ven/7wuU0x/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /usr/local/src/ven/7wuU0x/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /usr/local/src/ven/7wuU0x/build-aux/missing automake-1.16
...
MAINT = 
MAKEINFO = ${SHELL} /usr/local/src/ven/7wuU0x/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /usr/local/src/ven/7wuU0x
abs_srcdir = /usr/local/src/ven/7wuU0x
abs_top_builddir = /usr/local/src/ven/7wuU0x
abs_top_srcdir = /usr/local/src/ven/7wuU0x
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /usr/local/src/ven/7wuU0x/build-aux/install-sh
